      ...
      <div className="container flex h-16 items-center">
        <Link href="/" className="mr-6 flex items-center space-x-2" onClick={closeMobileMenu}>
          <Image
            ...
            className="h-9 w-9 rounded-sm object-contain" // Added rounded-sm and object-contain for better appearance
                ...
                <ul className="flex flex-col w-[300px] gap-1 p-4 md:w-[350px] lg:w-[400px]">
                  {corporateEventComponents.map((component) => (
                    <ListItem
                      ...
                      href={component.href}
                      onClick={closeMobileMenu} // Added onClick to close mobile menu on item click
                    >
